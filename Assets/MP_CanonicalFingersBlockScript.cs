...
/// </summary>
public class MP_CanonicalFingersBlockScript : Block {
    ...
    public MP_CanonicalFingersBlockScript(ExperimentRunner runner, DataTable trialTable, DataRow data, int index) : base(runner, trialTable, data, index) {
