...
/// </summary>
public class MP_CanonicalFingersExperimentScript : Experiment {
    ...
    public MP_CanonicalFingersExperimentScript(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
